...
<img width="648" height="450" alt="image" src="https://github.com/user-attachments/assets/6272b320-e77c-4aac-898b-e405f8840e7f" />


Для того чтобы получить адрес подсети нам необходимо взять ip адрес 192.168.200.139 и маску 255.255.255.224 перевести в двоичную систему исчисления и произвести сложение между ними припомощи логического и.
<img width="415" height="101" alt="image" src="https://github.com/user-attachments/assets/ef61a62f-26db-4be9-ba9e-fee52ff07904" />
...
>Ответ потому что маска подсети разделяет IPv4-адрес на две части: сетевую и хостовую. За счет данного разделения устройства определяют, находится ли получатель данных в той же подсети или для его доставки нужен маршрутизатор. 
